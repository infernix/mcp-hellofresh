...
const TOOLS = [
    ...
    },
    {
        ...
        description: "Read-only. Return a paginated slice of historical orders. Meal-box rows include historical recipe selections; charge-only rows are labeled with orderType and itemNames so agents can ignore dessert, premium, or add-on charges.",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
